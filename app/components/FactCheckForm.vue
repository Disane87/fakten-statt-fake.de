<template>
  <div class="max-w-6xl mx-auto mt-6 flex flex-col gap-8 lg:flex-row items-start justify-center">
    ...
    placeholder="Example: »Germany is doing well in the world.«" :disabled="loading" /> -->
      ...
      <button :disabled="loading || !text.trim()" @click="checkFact" class="w-full mt-4 px-5 py-3 rounded-lg text-white font-bold text-lg shadow transition flex flex-row justify-center items-center
