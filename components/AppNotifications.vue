<template>
  <div class="fixed top-4 right-4 z-50 space-y-2">
    <div
      ...
      :key="notification.id"
      class="bg-white rounded-lg shadow-lg border-l-4 p-4 max-w-sm transition-all duration-300"
      ...
      <div class="flex items-start">
        <div class="flex-shrink-0">
          <svg 
            ...
            viewBox="0 0 20 20"
          >
            <path v-if="notification.type === 'success'" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"/>
